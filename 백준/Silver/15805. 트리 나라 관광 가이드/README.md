...
1. 처음에는 121, 343, 353 이렇게 복잡하게 생각했다. 그러나 그냥 앞에서부터 받으면서 한번도 방문한적없으면 parents[cur]이 prev니까 바로바로 넣어주면 된다.
2. parents의 크기를 N으로 선언한 이유는 N을 넘지 않기 때문이다.
3. set으로 방문여부와 갯수를 파악한다.